...
//Estadistica descuentos por taller 
int promos ()
{
    /* code */
}
...
void inscribirTaller(int capacidad, int* totalTaller, int* totalMayores, int* participoAntes, int* sumaEdades) {
    ...
    for (int j = 1; j <= capacidad; j++) {
        ...
        if (hayInscripto == 1) {
            (*totalTaller)++;
            printf("Ingrese '1' si el inscripto realizó un curso previo\n");
    ...
    do {
        ...
        switch (opcion) {
            ...
            case 3:
                ...
                printf("La capacidad del local nº3 es %d\n", capacLocal3);
            ...
            case 4:
                ...
                printf("La capacidad del local nº4 es %d\n", capacLocal4);
            ...
            case 5:
                ...
                printf("La capacidad del local nº5 es %d\n", capacLocal5);
